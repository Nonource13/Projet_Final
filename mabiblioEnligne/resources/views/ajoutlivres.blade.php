        ...
        <div class="content-wrapper">
            ...
            <div class="page-content fade-in-up">
                ...
                <div class="col-md-12">
                    <div class="ibox">
                        <div class="ibox-head">
                            <div class="ibox-title">Ajout Livres</div>
                        ...
                        <div class="ibox-body">
                            <form action="{{route('routeaddLivreImage.addLivreImage')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-6 form-group">
                                        <label>Titre</label>
                                        <input class="form-control" type="text" placeholder="First Name" name="titre">
                                    </div>
                                    <div class="col-sm-6 form-group">
                                        <label>Genre</label>
                                        <input class="form-control" type="text" placeholder="First Name" name="genre">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Annee de publication</label>
                                    <input class="form-control" type="number" placeholder="Email address" name="anneedepublication">
                                </div>
                                <div class="form-group">
                                    <label>Photo de couverture</label>
                                    <input class="form-control" type="file" placeholder="Password" name="photo">
                                </div>
