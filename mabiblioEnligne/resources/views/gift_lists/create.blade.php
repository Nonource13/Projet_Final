...
@section('title', 'Créer une liste de cadeaux - Livres Gourmands')
...
<div class="container py-5">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Créer une liste</li>
        </ol>
    </nav>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-light">
                    <h2 class="mb-0 h5">Créer une nouvelle liste de cadeaux</h2>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('gift-lists.store') }}" method="POST">
                        @csrf
                        
                        <div class="mb-3">
                            <label for="title" class="form-label">Titre de la liste <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="title" name="title" value="{{ old('title') }}" required>
                            <small class="form-text text-muted">Exemple : "Anniversaire de Julie", "Liste de mariage", etc.</small>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="occasion" name="occasion">
                                    ...
                                    <option value="Mariage" {{ old('occasion') == 'Mariage' ? 'selected' : '' }}>Mariage</option>
                                    <option value="Noël" {{ old('occasion') == 'Noël' ? 'selected' : '' }}>Noël</option>
                                    <option value="Naissance" {{ old('occasion') == 'Naissance' ? 'selected' : '' }}>Naissance</option>
                                    <option value="Crémaillère" {{ old('occasion') == 'Crémaillère' ? 'selected' : '' }}>Crémaillère</option>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('gift-lists.index') }}" class="btn btn-outline-secondary">Annuler</a>
